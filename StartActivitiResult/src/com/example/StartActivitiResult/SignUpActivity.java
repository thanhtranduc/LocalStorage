...
import static com.example.StartActivitiResult.AuthenticatorActivity.*;
    ...
    private void createAccount() {
        ...
        new AsyncTask<String, Void, Intent>() {
            ...
            protected Intent doInBackground(String... params) {
                ...
                try {
                    authtoken = serverAuthenticate.userSignUp(name, accountName, accountPassword, AccountGeneral.AUTHTOKEN_TYPE_FULL_ACCESS);
